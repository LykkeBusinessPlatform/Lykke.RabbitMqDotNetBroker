...
public class QueueDeletionExpectedFailureFakeChannel : IModel
{
    ...
    {
        throw new OperationInterruptedException(new ShutdownEventArgs(ShutdownInitiator.Application, Constants.InternalError, "Internal error", nameof(QueueDelete)));
    }

    public void QueueDeleteNoWait(string queue, bool ifUnused, bool ifEmpty)
    {
        throw new OperationInterruptedException(new ShutdownEventArgs(ShutdownInitiator.Application, Constants.InternalError, "Internal error", nameof(QueueDeleteNoWait)));
    }
