...
{
    [TestFixture]
    public class ListenersRegistryTests
    {
        class MessageModel { }
        ...
        public void Add_RegistrationIsNotNull_AddsRegistration()
        {
            ...
            CollectionAssert.Contains(registry, registration);
            Assert.IsTrue(added);
        }
        ...
        public void AddMultipleRegistrations_AddsAll()
        {
            ...
            CollectionAssert.Contains(registry, registration1);
            CollectionAssert.Contains(registry, registration2);
        }
    }
