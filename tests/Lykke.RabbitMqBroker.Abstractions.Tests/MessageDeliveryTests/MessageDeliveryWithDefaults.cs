...
public sealed record MessageDeliveryWithNoTimestamps() : MessageDelivery(MessageDeliveryId.Create(), null, null, MessageDeliveryFailure.Empty, MessageRoute.Create(new NonEmptyString("exchange"), new NonEmptyString("queue"), "key"));
